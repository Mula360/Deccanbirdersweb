...
<section class="section-white" style="padding: 0 20px 40px;">
  <div class="section-boxed">
    <img src="" alt="A bird photographed by a Deccan Birders member" style="width:100%;aspect-ratio:16/6;object-fit:cover;background:var(--surface);border-radius:var(--radius-card);">
  </div>
</section>
...
<section class="section-surface section-pad" id="committee">
  <div class="section-boxed">
